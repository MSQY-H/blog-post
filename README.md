# MSQY 的文章备份！
![文章数](https://img.shields.io/badge/dynamic/json?url=https://raw.githubusercontent.com/MSQY-H/blog-post/stats/stats.json&label=文章数&query=$.files.message&color=blue)
![总字数](https://img.shields.io/badge/dynamic/json?url=https://raw.githubusercontent.com/MSQY-H/blog-post/stats/stats.json&label=总字数&query=$.words.message&color=green)
![最后更新](https://img.shields.io/badge/dynamic/json?url=https://raw.githubusercontent.com/MSQY-H/blog-post/stats/stats.json&label=最后更新&query=$.updated.message&color=blueviolet)
![提交数](https://img.shields.io/badge/dynamic/json?url=https://raw.githubusercontent.com/MSQY-H/blog-post/stats/stats.json&label=提交数&query=$.commits.message&color=red)
...
- 🌏 主要链接：[https://msqy-h.github.io/](https://msqy-h.github.io/)![GitHub Pages](https://img.shields.io/badge/部署于-GitHub%20Pages-brightgreen?logo=github)
- 🏷️ 镜像链接：[https://www.msqy.cc.cd](https://www.msqy.cc.cd)![Cloudflare](https://img.shields.io/badge/部署于-Cloudflare%20Pages-orange?logo=cloudflarepages)

## 版权声明

本仓库所有文章采用 [CC BY-NC-SA 4.0](http://creativecommons.org/licenses/by-nc-sa/4.0/) 协议进行许可。
...
您不必因为公共领域的作品要素而遵守许可协议，或者您的使用被可适用的[例外或限制所](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh-hans#ref-exception-or-limitation)允许。
...
摘自[署名—非商业性使用—禁止演绎 4.0 协议国际版 CC BY-NC-SA 4.0 Deed](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh-hans)