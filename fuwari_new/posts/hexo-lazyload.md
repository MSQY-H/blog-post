...
html 千变万化，正则可能破坏掉 html 标签导致页面出现错误，可能波及 `<scripts>` 标签。:spoiler['祖传代码发力了（']
...
``` javascript title="lazyload.js" collapse={6-33}
'use strict'
