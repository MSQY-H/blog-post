...
很简单。具体的语法，请看官方文档。:spoiler[话说为什么是放在 demo 而不是文档啊]

::link-card{url="https://everfu.github.io/solitude-demo/posts/8f9926b7.html" title="外挂标签使用 | Solitude" description="这篇文章介绍了外挂标签的使用。"}
...
> [!NOTE]
> 由于 Fuwari 暂不支持 Hexo 标签，这里可能无法正常渲染
...
经过与B大哥与D大哥两位好朋友的探讨研究后，我终于发现了问题。
...
``` javascript title="JavaScript" collapse={6-682}
