...
::link-card{url="https://zhuanlan.zhihu.com/p/1956286037249757963" title="［ Termux | Zsh |…" description="如果你发现自己的终端中有很多乱码…"}

## 效果图

![效果图](/images/termux-zsh/result.webp)
...
安装时会询问 `Do you want to change your default shell to zsh?`，直接按回车即可。
...
::link-card{url="https://github.com/termux/termux-styling" title="GitHub - termux…" description="A Termux add-on app to customize…"}

::link-card{url="https://f-droid.org/packages/com.termux.styling/" title="F-Droid - Termux…" description="Termux:Styling Customize…"}
...
说到 Termux，以后我打算写写 Neovim 的安装和懒人配置方式。:spoilerblock[在手机用 Neovim？感觉有点豪了]
