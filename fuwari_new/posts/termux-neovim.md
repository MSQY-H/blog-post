...
![效果图](/images/termux-neovim/result.webp)
...
::link-card{url="https://www.lazyvim.org/" title="LazyVim - Getting…" description="LazyVim is a Neovim setup …'"}

如果用的是普通手机（遥控器比例），官方 LazyVim 可能适配的不是很好，我找到了为 Termux 定制的 LazyVim，我在这里会用该 LazyVim 的脚本来配置。

::github{repo="Veha0001/dotLazyVim"}
...
::link-card{url="https://github.com/termux/termux-api" title="GitHub - termux…" description="This is an app exposing Android…'"}

::link-card{url="https://f-droid.org/packages/com.termux.api/" title="F-Droid - Termux…" description="Termux:API is an add-on for…'"}
...
由于配置内容过多，这里不详细讲了，具体看[官方文档](https://www.lazyvim.org/)
...
::link-card{url="http://patorjk.com/software/taag/" title="Text to ASCII…" description="An online text conversion …"}
